...
describe("Widget Element Grabber", () => {
  ...
  it("should let you grab widget Elements", (done) => {
    ...
    self.widgetElementGrabber.grabWidgetElements().then(() => {
      ...
      expect(self.endPointTransceiver.getWidget).urlKeysWere(["repo0005"])
      ...
      expect(self.elementInstanceGrabber.processElementInstances).toHaveBeenCalledWith(
        {
          repositoryId: 'repo0003',
          descriptor: {
            displayName: 'My Widget',

...
describe("Framework Putter", () => {
  ...
  beforeEach(() => {
    ...
    self.endPointTransceiver = mockery.mockModule("../endPointTransceiver", "startFileUpload", "doFileSegmentUpload", "deleteFile")
    ...
    self.endPointTransceiver.deleteFile.returnsResponse({})
  })
